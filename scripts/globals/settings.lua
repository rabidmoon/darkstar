...
START_GIL = 20,000; -- Amount of gil given to newly created characters.
...
SCAVENGE_RATE = 0.3; --The chance of obtaining an item when you use the Ranger job ability Scavenge.  Do not set above 1!
