...
function onTrigger(player,page)
    if (page == 0 or page == nil) then
        player:PrintToPlayer( "1: Crystal Depot, 2: Pharmacy, 3: Food, 4: Tools & Ammo, 5: Weaponry, 6: Armory, 7: Beyond Infinity, 8: Misc, 9: Attachments ");
	...
	elseif (page == 61) then
        ...
        player:PrintToPlayer( "Attachments: Welcome, Kupo!");
