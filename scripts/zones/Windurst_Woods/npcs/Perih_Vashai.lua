...
--printf("RESULT: %u",option);
	...
	elseif(csid == 0x020f) then -- complete quest RNG AF1
		if (player:getFreeSlotsCount() <= 2) then 
			...
			player:messageSpecial(ITEM_CANNOT_BE_OBTAINED,17256);
			player:messageSpecial(ITEM_CANNOT_BE_OBTAINED,17218);
		else 
			player:addItem(17188);
			player:addItem(17256, 1, 45, 1);
			player:addItem(17218, 1, 45, 3);
