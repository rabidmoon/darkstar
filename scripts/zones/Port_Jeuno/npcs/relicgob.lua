...
if (job == 7) and (trade:hasItemQty(17643, 1)) and trade:hasItemQty( 1456, 10 ) and (player:getVar("PLDAFweapon") == 3)
             -- Complete the trade..
            player:tradeComplete();
			player:PrintToPlayer("Netblyx : Here you go.", 0xD);
			player:addItem(18274, 1, 519,6);
...
if (job == 8) and (trade:hasItemQty(16798, 1)) and trade:hasItemQty( 1456, 10 ) and (player:getVar("DRKAFweapon") == 3)
             -- Complete the trade..
            player:tradeComplete();
			player:PrintToPlayer("Netblyx : Here you go.", 0xD);
...
if (job == 9) and (trade:hasItemQty(16680, 1)) and trade:hasItemQty( 1453, 10 ) and (player:getVar("BSTAFweapon") == 3)
             -- Complete the trade..
            player:tradeComplete();
			player:PrintToPlayer("Netblyx : Here you go.", 0xD);
...
if (job == 11) and (trade:hasItemQty(17256, 1)) and trade:hasItemQty( 1453, 10 ) and (player:getVar("RNGAFweapongun") == 3)
             -- Complete the trade..
            player:tradeComplete();
			player:PrintToPlayer("Netblyx : Here you go.", 0xD);
...
if (job == 13) and (trade:hasItemQty(17772, 1)) and trade:hasItemQty( 1450, 10 ) and (player:getVar("NINAFweapon") == 3)
             -- Complete the trade..
            player:tradeComplete();
			player:PrintToPlayer("Netblyx : Here you go.", 0xD);
...
if (job == 14) and (trade:hasItemQty(17478, 1)) and trade:hasItemQty( 1456, 10 ) and (player:getVar("DRGAFweapon") == 3)
             -- Complete the trade..
            player:tradeComplete();
			player:PrintToPlayer("Netblyx : Here you go.", 0xD);
...
if (job == 15) and (trade:hasItemQty(17812, 1)) and trade:hasItemQty( 1450, 10 ) and (player:getVar("SAMAFweapon") == 3)
             -- Complete the trade..
            player:tradeComplete();
			player:PrintToPlayer("Netblyx : Here you go.", 0xD);
