        ...
        GALLIJAUX_CARP_STATUS          = 8109; -- How's it going with you? I've got <number> [carp/carps] now--don't let me down!
        GALLIJAUX_HELP_OTHER_BROTHER   = 8112; -- What's this? You're helping me brother, are you? Be gone with you, then! Out of my sight!
        JOULET_CARP_STATUS             = 8121; -- How goes it? I've got a hold of <number> [carp/carps] now. Keep bringing them--I wouldn't want to lose to my brother!
        JOULET_HELP_OTHER_BROTHER      = 8124; -- Ah, so you've been helping my brother, have you!? Traitor! Turncoat! Be gone with you!
        BONMAURIEUT_CLOSED_DIALOG      = 8281; -- I would like to sell goods from the Elshimo Uplands, but I cannot, as it's under foreign control.
        NIMIA_OPEN_DIALOG              = 8282; -- Hello, friend! Can I interest you in specialty goods from the Elshimo Lowlands?
        PATOLLE_OPEN_DIALOG            = 8283; -- Hey, [mister/miss]! How about some specialty goods from Kuzotz?
        BONMAURIEUT_OPEN_DIALOG        = 8284; -- My shipment is in! Would you like to see what has just arrived from the Elshimo Uplands?
        ANSWALD_MESSAGE                = 8421; -- Answald looks over curiously for a moment.
        PRIETTA_MESSAGE                = 8422; -- Prietta looks over curiously for a moment.
        MIENE_MESSAGE                  = 8423; -- Miene looks over curiously for a moment.
        PORTAURE_MESSAGE               = 8424; -- Portaure looks over curiously for a moment.
        AUVARE_MESSAGE                 = 8425; -- Auvare looks over curiously for a moment.
