...
function onMobSpawn(mob)
	...
	local general = 0;
	local genscap = 0;
	printf("ARRAPAGO SIEGE HAS STARTED!!! Spawning Helpers in 45 Seconds.");
	...
	local mirror1 = GetMobByID(16998838);
	local mirror2 = GetMobByID(16998839);
	local mirror3 = GetMobByID(16998840);
...
function onMobRoam(mob)
    ...
    if (os.time() - poptime > 6 and index <= 13) then
        SpawnMob(BesiegeIDs.arrapagohelpers[index]);
