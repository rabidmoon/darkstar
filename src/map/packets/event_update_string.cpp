    ...
    uint32 param8)
{
    ...
    memcpy(data + 0x28, string0.c_str(), string0.size());
    memcpy(data + 0x38, string1.c_str(), string1.size());
    memcpy(data + 0x48, string2.c_str(), string2.size());
    memcpy(data + 0x58, string3.c_str(), string3.size());
}
